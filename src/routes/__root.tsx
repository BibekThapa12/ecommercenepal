    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-gradient-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-elegant transition-base hover:opacity-90"
          >
            Go home
          </Link>
        </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium text-foreground transition-base hover:bg-accent"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Reactify Commerce — Premium Online Shopping in Nepal" },
      {
        name: "description",
        content:
          "Reactify Commerce by Reactify Software Technologies — premium curated shopping for Nepal with eSewa, Khalti, FonePay, and Cash on Delivery.",
      },
      { name: "author", content: "Reactify Software Technologies Pvt. Ltd." },
      { property: "og:site_name", content: "Reactify Commerce" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Fraunces:opsz,wght@9..144,600;9..144,700;9..144,800;9..144,900&display=swap",
      },
    ],
  }),
